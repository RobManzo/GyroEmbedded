...
\***HEARTH SYMBOL***\
: HEARTH_SYM SWAP 1 PR
    DUP 2 PD 9 3 PICK VERT_LINE     1 PR
    DUP 2 PD 9 3 PICK VERT_LINE     1 PR
    DUP 2 PD B 3 PICK VERT_LINE     1 PR
    DUP 2 PD B 3 PICK VERT_LINE     1 PR
    DUP D 3 PICK VERT_LINE          1 PR
    DUP D 3 PICK VERT_LINE          1 PR
    DUP E 3 PICK VERT_LINE          1 PR
    DUP E 3 PICK VERT_LINE          1 PR
    DUP F 3 PICK VERT_LINE          1 PR
    DUP F 3 PICK VERT_LINE          1 PR
    DUP 2 PD 10 3 PICK VERT_LINE    1 PR 
    DUP 2 PD 10 3 PICK VERT_LINE    1 PR 
    DUP 3 PD 11 3 PICK VERT_LINE    1 PR
    DUP F 3 PICK VERT_LINE          1 PR
    DUP F 3 PICK VERT_LINE          1 PR
    DUP E 3 PICK VERT_LINE          1 PR
    DUP E 3 PICK VERT_LINE          1 PR
